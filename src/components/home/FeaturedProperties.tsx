...
export default function FeaturedProperties() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 to-gold-50" id="biens">
            ...
            <Card key={property.id} className="group overflow-hidden">
              <div className="relative h-56 overflow-hidden">
                ...
                <button
                  ...
                  aria-label={favorites.has(property.id) ? 'Retirer des favoris' : 'Ajouter aux favoris'}
                >
                  <Heart
                    className={`w-5 h-5 ${
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-4 text-gray-600 text-sm mb-4">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-medium font-sans">{property.bedrooms}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <Bath className="w-4 h-4 text-gold-500" />
                    <span className="font-medium font-sans">{property.bathrooms}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <Maximize className="w-4 h-4 text-gold-500" />
                    <span className="font-medium font-sans">{property.area}m²</span>
                  </div>
                </div>
